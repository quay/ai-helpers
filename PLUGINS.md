...
- **`/dev:frontend`** - Load Quay React frontend context. Covers data flow, testing, and where Quay conventions override PatternFly defaults. Auto-invoked by /code when the ticket touches web/.
